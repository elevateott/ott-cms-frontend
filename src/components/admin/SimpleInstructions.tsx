    ...
    <div className="mb-6 p-4 border border-gray-200 rounded-md">
      ...
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside ml-4 space-y-1">
          <li>Go to <a href="https://www.dropbox.com/developers/apps" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Dropbox Developer Console</a></li>
      ...
      <div className="mb-4">
        ...
        <ul className="list-disc list-inside ml-4 space-y-1">
          ...
          <li>Create OAuth Credentials and copy both the API Key and Client ID into the fields below.</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside ml-4 space-y-1">
          <li>Go to <a href="https://portal.azure.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Microsoft Azure Portal</a></li>
