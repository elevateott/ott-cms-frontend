      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Test various API endpoints to see if they're working</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-wrap gap-2">
              ...
              <Button onClick={() => testApi('/api/test-api')} disabled={loading} variant="outline">
                {loading ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    Testing...
              ...
              <Button
                onClick={() => testApi('/api/direct-settings')}
                disabled={loading}
                variant="outline"
              >
                {loading ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>The result of the API call</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
