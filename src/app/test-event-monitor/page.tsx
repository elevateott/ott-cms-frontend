...
export default function TestEventMonitor() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Event Monitor Test</h1>
      ...
      <div className="mb-6">
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>Click "Test Custom Event" to emit an event with additional fields</li>
          <li>Watch the Event Monitor in the bottom-left corner for the event</li>
        </ol>
      </div>
      ...
      {/* Include the EventMonitor component */}
      <EventMonitor />
    </div>
  )
}
