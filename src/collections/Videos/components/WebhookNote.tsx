  ...
  return (
    <div className="p-4 mb-6 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <p className="text-sm text-gray-700">
        If you&apos;re seeing 401 errors, check that the webhook secret in your Mux dashboard
        matches the one in your .env file (MUX_WEBHOOK_SECRET).
      </p>
      <p>
        Don&apos;t worry if you don&apos;t see your video right away - it takes a few minutes to
        process.
      </p>
    </div>
  )
