...
export const subtitle_kind = pgEnum('subtitle_kind', ['subtitles', 'captions', 'descriptions'])
export const enum_video_assets_source_type = pgEnum('enum_video_assets_source_type', [
  'mux',
  'embedded',
])
export const mux_status = pgEnum('mux_status', ['uploading', 'processing', 'ready', 'error'])
export const video_quality = pgEnum('video_quality', ['basic', 'plus', 'premium'])
export const max_resolution = pgEnum('max_resolution', ['1080p'])
export const playback_policy = pgEnum('playback_policy', ['public', 'signed'])
export const enum_video_assets_status = pgEnum('enum_video_assets_status', ['draft', 'published'])
export const enum__video_assets_v_version_source_type = pgEnum(
  'enum__video_assets_v_version_source_type',
  ['mux', 'embedded'],
)
export const enum__video_assets_v_version_status = pgEnum('enum__video_assets_v_version_status', [
  'draft',
  'published',
])
...
export const enum__content_v_version_meta_social_media_twitter_card = pgEnum(
  'enum__content_v_version_meta_social_media_twitter_card',
  ['summary', 'summary_large_image', 'player'],
)
...
export const video_assets_subtitles_tracks = pgTable(
  'video_assets_subtitles_tracks',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    name: varchar('name'),
    kind: subtitle_kind('kind').default('subtitles'),
    closedCaptions: boolean('closed_captions').default(false),
    muxTrackId: varchar('mux_track_id'),
    url: varchar('url'),
  },
  (columns) => ({
    _orderIdx: index('video_assets_subtitles_tracks_order_idx').on(columns._order),
    _parentIDIdx: index('video_assets_subtitles_tracks_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [video_assets.id],
      name: 'video_assets_subtitles_tracks_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const video_assets = pgTable(
  'video_assets',
  {
    id: serial('id').primaryKey(),
    title: varchar('title'),
    slug: varchar('slug'),
    slugLock: boolean('slug_lock').default(true),
    sourceType: enum_video_assets_source_type('source_type').default('mux'),
    ...
    muxData_status: mux_status('mux_data_status').default('uploading'),
    muxAdvancedSettings_videoQuality: video_quality('mux_advanced_settings_video_quality').default(
      'basic',
    ),
    muxAdvancedSettings_maxResolution: max_resolution(
      'mux_advanced_settings_max_resolution',
    ).default('1080p'),
    muxAdvancedSettings_playbackPolicy: playback_policy(
    ...
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    _status: enum_video_assets_status('_status').default('draft'),
  },
  (columns) => ({
    video_assets_slug_idx: index('video_assets_slug_idx').on(columns.slug),
    video_assets_thumbnail_idx: index('video_assets_thumbnail_idx').on(columns.thumbnail),
    video_assets_updated_at_idx: index('video_assets_updated_at_idx').on(columns.updatedAt),
    video_assets__status_idx: index('video_assets__status_idx').on(columns._status),
  }),
)

export const _video_assets_v_version_subtitles_tracks = pgTable(
  '_video_assets_v_version_subtitles_tracks',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_video_assets_v_version_subtitles_tracks_order_idx').on(columns._order),
    _parentIDIdx: index('_video_assets_v_version_subtitles_tracks_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_video_assets_v.id],
      name: '_video_assets_v_version_subtitles_tracks_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _video_assets_v = pgTable(
  '_video_assets_v',
  {
    id: serial('id').primaryKey(),
    parent: integer('parent_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
    version_title: varchar('version_title'),
    version_slug: varchar('version_slug'),
    version_slugLock: boolean('version_slug_lock').default(true),
    version_sourceType:
      enum__video_assets_v_version_source_type('version_source_type').default('mux'),
    version_overrideDRM: boolean('version_override_d_r_m').default(false),
    version_useDRM: boolean('version_use_d_r_m').default(false),
    version_drmConfigurationId: varchar('version_drm_configuration_id'),
    version_muxData_uploadId: varchar('version_mux_data_upload_id'),
    version_muxData_assetId: varchar('version_mux_data_asset_id'),
    version_muxData_playbackId: varchar('version_mux_data_playback_id'),
    version_muxData_status: mux_status('version_mux_data_status').default('uploading'),
    version_muxAdvancedSettings_videoQuality: video_quality(
      'version_mux_advanced_settings_video_quality',
    ).default('basic'),
    version_muxAdvancedSettings_maxResolution: max_resolution(
      'version_mux_advanced_settings_max_resolution',
    ).default('1080p'),
    version_muxAdvancedSettings_playbackPolicy: playback_policy(
      'version_mux_advanced_settings_playback_policy',
    ).default('public'),
    version_muxAdvancedSettings_normalizeAudio: boolean(
      'version_mux_advanced_settings_normalize_audio',
    ).default(false),
    version_muxAdvancedSettings_autoGenerateCaptions: boolean(
      'version_mux_advanced_settings_auto_generate_captions',
    ).default(false),
    version_embeddedUrl: varchar('version_embedded_url'),
    version_duration: numeric('version_duration'),
    version_aspectRatio: varchar('version_aspect_ratio'),
    version_thumbnail: integer('version_thumbnail_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    version_muxThumbnailUrl: varchar('version_mux_thumbnail_url'),
    version_createdAt: timestamp('version_created_at', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    ...
    version__status: enum__video_assets_v_version_status('version__status').default('draft'),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => ({
    _video_assets_v_parent_idx: index('_video_assets_v_parent_idx').on(columns.parent),
    _video_assets_v_version_version_slug_idx: index('_video_assets_v_version_version_slug_idx').on(
      columns.version_slug,
    ),
    _video_assets_v_version_version_thumbnail_idx: index(
      '_video_assets_v_version_version_thumbnail_idx',
    ).on(columns.version_thumbnail),
    _video_assets_v_version_version_updated_at_idx: index(
      '_video_assets_v_version_version_updated_at_idx',
    ).on(columns.version_updatedAt),
    _video_assets_v_version_version__status_idx: index(
      '_video_assets_v_version_version__status_idx',
    ).on(columns.version__status),
    _video_assets_v_created_at_idx: index('_video_assets_v_created_at_idx').on(columns.createdAt),
    _video_assets_v_updated_at_idx: index('_video_assets_v_updated_at_idx').on(columns.updatedAt),
    _video_assets_v_latest_idx: index('_video_assets_v_latest_idx').on(columns.latest),
    _video_assets_v_autosave_idx: index('_video_assets_v_autosave_idx').on(columns.autosave),
  }),
)
...
export const content_bonus_videos = pgTable(
  'content_bonus_videos',
  {
    ...
    title: varchar('title'),
    description: varchar('description'),
    video: integer('video_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
  },
  (columns) => ({
...
export const content = pgTable(
  'content',
  {
    ...
    mainVideo: integer('main_video_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
    trailerVideo: integer('trailer_video_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
    status: enum_content_status('status').default('draft'),
  ...
  (columns) => ({
    ...
    content__status_idx: index('content__status_idx').on(columns._status),
  }),
)
...
export const _content_v_version_bonus_videos = pgTable(
  '_content_v_version_bonus_videos',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_content_v_version_bonus_videos_order_idx').on(columns._order),
    _parentIDIdx: index('_content_v_version_bonus_videos_parent_id_idx').on(columns._parentID),
    _content_v_version_bonus_videos_video_idx: index(
      '_content_v_version_bonus_videos_video_idx',
    ).on(columns.video),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_content_v.id],
      name: '_content_v_version_bonus_videos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _content_v_version_tags = pgTable(
  '_content_v_version_tags',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_content_v_version_tags_order_idx').on(columns._order),
    _parentIDIdx: index('_content_v_version_tags_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_content_v.id],
      name: '_content_v_version_tags_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _content_v = pgTable(
  '_content_v',
  {
    ...
    version_slug: varchar('version_slug'),
    version_slugLock: boolean('version_slug_lock').default(true),
    version_posterImage: integer('version_poster_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    ...
    version_mainVideo: integer('version_main_video_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
    version_trailerVideo: integer('version_trailer_video_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
    version_status: enum__content_v_version_status('version_status').default('draft'),
    version_isPublished: boolean('version_is_published').default(false),
    version_isFree: boolean('version_is_free').default(false),
    version_publishAt: timestamp('version_publish_at', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }),
    version_unpublishAt: timestamp('version_unpublish_at', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
    }),
    ...
    version_meta_socialMedia_twitterCard: enum__content_v_version_meta_social_media_twitter_card(
      'version_meta_social_media_twitter_card',
    ).default('summary_large_image'),
    version_meta_socialMedia_twitterHandle: varchar('version_meta_social_media_twitter_handle'),
    version_updatedAt: timestamp('version_updated_at', {
  ...
  (columns) => ({
    _content_v_parent_idx: index('_content_v_parent_idx').on(columns.parent),
    _content_v_version_version_slug_idx: index('_content_v_version_version_slug_idx').on(
      columns.version_slug,
    ),
    _content_v_version_version_poster_image_idx: index(
      '_content_v_version_version_poster_image_idx',
    ).on(columns.version_posterImage),
    _content_v_version_version_main_video_idx: index(
      '_content_v_version_version_main_video_idx',
    ).on(columns.version_mainVideo),
    _content_v_version_version_trailer_video_idx: index(
      '_content_v_version_version_trailer_video_idx',
    ).on(columns.version_trailerVideo),
    _content_v_version_meta_version_meta_image_idx: index(
      '_content_v_version_meta_version_meta_image_idx',
    ).on(columns.version_meta_image),
    _content_v_version_version_updated_at_idx: index(
      '_content_v_version_version_updated_at_idx',
    ).on(columns.version_updatedAt),
    _content_v_version_version_created_at_idx: index(
      '_content_v_version_version_created_at_idx',
    ).on(columns.version_createdAt),
    _content_v_version_version__status_idx: index('_content_v_version_version__status_idx').on(
      columns.version__status,
    ),
    _content_v_created_at_idx: index('_content_v_created_at_idx').on(columns.createdAt),
    _content_v_updated_at_idx: index('_content_v_updated_at_idx').on(columns.updatedAt),
    _content_v_latest_idx: index('_content_v_latest_idx').on(columns.latest),
    _content_v_autosave_idx: index('_content_v_autosave_idx').on(columns.autosave),
  }),
)
...
export const _content_v_rels = pgTable(
  ...
  (columns) => ({
    order: index('_content_v_rels_order_idx').on(columns.order),
    parentIdx: index('_content_v_rels_parent_idx').on(columns.parent),
    pathIdx: index('_content_v_rels_path_idx').on(columns.path),
    _content_v_rels_categories_id_idx: index('_content_v_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    _content_v_rels_creators_id_idx: index('_content_v_rels_creators_id_idx').on(
      columns.creatorsID,
    ),
    _content_v_rels_subscription_plans_id_idx: index(
      '_content_v_rels_subscription_plans_id_idx',
    ...
    creatorsIdFk: foreignKey({
      columns: [columns['creatorsID']],
      foreignColumns: [creators.id],
      name: '_content_v_rels_creators_fk',
    }).onDelete('cascade'),
    'subscription-plansIdFk': foreignKey({
      columns: [columns['subscription-plansID']],
      foreignColumns: [subscription_plans.id],
      name: '_content_v_rels_subscription_plans_fk',
    }).onDelete('cascade'),
  }),
)
...
export const series = pgTable(
  'series',
  {
    ...
    trailer: integer('trailer_id').references(() => video_assets.id, {
      onDelete: 'set null',
    }),
...
export const transactions = pgTable(
  'transactions',
  {
    ...
    subscriber: integer('subscriber_id').references(() => subscribers.id, {
      onDelete: 'set null',
    }),
    event: integer('event_id').references(() => live_events.id, {
      onDelete: 'set null',
    }),
    content: integer('content_id').references(() => content.id, {
      onDelete: 'set null',
    }),
    plan: integer('plan_id').references(() => subscription_plans.id, {
      onDelete: 'set null',
    }),
    product: integer('product_id').references(() => digital_products.id, {
      onDelete: 'set null',
    }),
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    videoassetsID: integer('video_assets_id'),
    contentID: integer('content_id'),
    creatorsID: integer('creators_id'),
    seriesID: integer('series_id'),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_video_assets_id_idx: index(
      'payload_locked_documents_rels_video_assets_id_idx',
...
export const relations_video_assets_subtitles_tracks = relations(
  video_assets_subtitles_tracks,
  ({ one }) => ({
    _parentID: one(video_assets, {
      fields: [video_assets_subtitles_tracks._parentID],
      references: [video_assets.id],
      relationName: 'subtitles_tracks',
    }),
  }),
)
export const relations_video_assets = relations(video_assets, ({ one, many }) => ({
  subtitles_tracks: many(video_assets_subtitles_tracks, {
    relationName: 'subtitles_tracks',
  }),
  thumbnail: one(media, {
    fields: [video_assets.thumbnail],
    references: [media.id],
    relationName: 'thumbnail',
  }),
}))
export const relations__video_assets_v_version_subtitles_tracks = relations(
  _video_assets_v_version_subtitles_tracks,
  ({ one }) => ({
    _parentID: one(_video_assets_v, {
      fields: [_video_assets_v_version_subtitles_tracks._parentID],
      references: [_video_assets_v.id],
      relationName: 'version_subtitles_tracks',
    }),
  }),
)
export const relations__video_assets_v = relations(_video_assets_v, ({ one, many }) => ({
  parent: one(video_assets, {
    fields: [_video_assets_v.parent],
    references: [video_assets.id],
    relationName: 'parent',
  }),
  version_subtitles_tracks: many(_video_assets_v_version_subtitles_tracks, {
    relationName: 'version_subtitles_tracks',
  }),
  version_thumbnail: one(media, {
    fields: [_video_assets_v.version_thumbnail],
    references: [media.id],
...
export const relations_content = relations(content, ({ one, many }) => ({
  ...
  mainVideo: one(video_assets, {
    fields: [content.mainVideo],
    references: [video_assets.id],
    relationName: 'mainVideo',
  }),
  trailerVideo: one(video_assets, {
...
export const relations__content_v_version_bonus_videos = relations(
  _content_v_version_bonus_videos,
  ({ one }) => ({
    _parentID: one(_content_v, {
      fields: [_content_v_version_bonus_videos._parentID],
      references: [_content_v.id],
      relationName: 'version_bonusVideos',
    }),
    video: one(video_assets, {
      fields: [_content_v_version_bonus_videos.video],
      references: [video_assets.id],
      relationName: 'video',
    }),
  }),
)
export const relations__content_v_version_tags = relations(_content_v_version_tags, ({ one }) => ({
  _parentID: one(_content_v, {
    fields: [_content_v_version_tags._parentID],
    references: [_content_v.id],
...
export const relations__content_v_rels = relations(_content_v_rels, ({ one }) => ({
  ...
  creatorsID: one(creators, {
    fields: [_content_v_rels.creatorsID],
    references: [creators.id],
    relationName: 'creators',
  }),
  'subscription-plansID': one(subscription_plans, {
    fields: [_content_v_rels['subscription-plansID']],
    references: [subscription_plans.id],
    relationName: 'subscription-plans',
  }),
}))
export const relations__content_v = relations(_content_v, ({ one, many }) => ({
  ...
  version_posterImage: one(media, {
    fields: [_content_v.version_posterImage],
    references: [media.id],
    relationName: 'version_posterImage',
  }),
  version_mainVideo: one(video_assets, {
    fields: [_content_v.version_mainVideo],
    references: [video_assets.id],
    relationName: 'version_mainVideo',
  }),
  version_trailerVideo: one(video_assets, {
    fields: [_content_v.version_trailerVideo],
    references: [video_assets.id],
    relationName: 'version_trailerVideo',
  }),
  version_bonusVideos: many(_content_v_version_bonus_videos, {
    relationName: 'version_bonusVideos',
  }),
  version_tags: many(_content_v_version_tags, {
    relationName: 'version_tags',
  }),
  version_meta_image: one(media, {
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    videoassetsID: one(video_assets, {
...
type DatabaseSchema = {
  ...
  subtitle_kind: typeof subtitle_kind
  enum_video_assets_source_type: typeof enum_video_assets_source_type
  mux_status: typeof mux_status
  video_quality: typeof video_quality
  max_resolution: typeof max_resolution
  playback_policy: typeof playback_policy
  enum_video_assets_status: typeof enum_video_assets_status
  enum__video_assets_v_version_source_type: typeof enum__video_assets_v_version_source_type
  enum__video_assets_v_version_status: typeof enum__video_assets_v_version_status
  ...
  enum__content_v_version_meta_social_media_twitter_card: typeof enum__content_v_version_meta_social_media_twitter_card
  ...
  video_assets_subtitles_tracks: typeof video_assets_subtitles_tracks
  video_assets: typeof video_assets
  _video_assets_v_version_subtitles_tracks: typeof _video_assets_v_version_subtitles_tracks
  _video_assets_v: typeof _video_assets_v
  content_bonus_videos: typeof content_bonus_videos
  content_tags: typeof content_tags
  content: typeof content
  content_rels: typeof content_rels
  _content_v_version_bonus_videos: typeof _content_v_version_bonus_videos
  _content_v_version_tags: typeof _content_v_version_tags
  ...
  relations_video_assets_subtitles_tracks: typeof relations_video_assets_subtitles_tracks
  relations_video_assets: typeof relations_video_assets
  relations__video_assets_v_version_subtitles_tracks: typeof relations__video_assets_v_version_subtitles_tracks
  relations__video_assets_v: typeof relations__video_assets_v
  ...
  relations__content_v_version_bonus_videos: typeof relations__content_v_version_bonus_videos
  relations__content_v_version_tags: typeof relations__content_v_version_tags
